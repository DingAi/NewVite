...
describe("The DragPreviewImage component", function() {
    afterEach(cleanup);
    it("can render a preview image into the document", _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
        var onConnect, TestComponent, Provider;
        return regeneratorRuntime.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                    onConnect = vi.fn();
                    TestComponent = defineComponent(function() {
                        var ref = _slicedToArray(useDrag({
                            type: "KNIGHT",
                        ...
                        var isDragging = toRefs(collect.value).isDragging;
                        var knightStyle = {
                            color: "black"
                        };
                    ...
                    Provider = defineComponent(function() {
                        return function() {
