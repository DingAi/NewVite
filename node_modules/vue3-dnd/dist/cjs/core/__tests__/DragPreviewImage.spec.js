...
var _dragPreviewImage = _interopRequireDefault(require("../DragPreviewImage"));
            ...
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                    ...
                    TestComponent = (0, _vueDemi).defineComponent(function() {
                        ...
                        }), 3), collect = ref[0], drag = ref[1], preview = ref[2];
                        var isDragging = (0, _vueDemi).toRefs(collect.value).isDragging;
                        var knightStyle = {
                            color: "black"
                        };
                        var connectPreview = function(a, b) {
                            onConnect(a, b);
                            return preview(a, b);
                        };
                        return function() {
                    ...
                    Provider = (0, _vueDemi).defineComponent(function() {
                        return function() {
                            return (0, _vueDemi).h(_core.DndProvider, {
                                backend: _reactDndTestBackend.TestBackend
                            }, function() {
                                return [
                                    (0, _vueDemi).h(TestComponent)
                                ];
                            });
                        };
                    });
                    _ctx.next = 5;
                    return (0, _vue).render(Provider);
                case 5:
                case "end":
                    return _ctx.stop();
            }
