...
function createSingletonDndContext(backend) {
    ...
    var ctx = context;
    if (!ctx[INSTANCE_SYM]) {
        ctx[INSTANCE_SYM] = (0, _dndCore).createDragDropManager(backend, context, options, debugMode);
    }
...
var _default = (0, _vueDemi).defineComponent({
    ...
    setup: function setup(props, param) {
        ...
        (0, _vueDemi).onUnmounted(function() {
            if (isGlobalInstance) {
        ...
        (0, _dndContext).useDndContextProvider(manager);
        var ref1;
        return function() {
            var ref;
