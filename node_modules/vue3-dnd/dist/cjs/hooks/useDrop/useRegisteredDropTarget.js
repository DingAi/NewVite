...
function useRegisteredDropTarget(spec, monitor, connector) {
    ...
    (0, _vueDemi).watchEffect(function registerDropTarget(onCleanup) {
        var ref = _slicedToArray((0, _internals).registerTarget(accept, dropTarget, manager), 2), handlerId = ref[0], unregister = ref[1];
