...
function useRegisteredDragSource(spec, monitor, connector) {
    ...
    (0, _vueDemi).watchEffect(function registerDragSource(onCleanup) {
        if ((0, _vueDemi).unref(itemType) != null) {
            var ref = _slicedToArray((0, _internals).registerSource((0, _vueDemi).unref(itemType), (0, _vueDemi).unref(handler), (0, _vueDemi).unref(manager)), 2), handlerId = ref[0], unregister = ref[1];
            (0, _vueDemi).unref(monitor).receiveHandlerId(handlerId);
            (0, _vueDemi).unref(connector).receiveHandlerId(handlerId);
