...
var nodeConverters = [
  ...
  function forStatement(position, buffer, readString) {
    ...
    const init2 = initPosition === 0 ? null : convertNode(initPosition, buffer, readString);
...
var ImportExpression = class extends NodeBase {
  ...
  getDeterministicImportedNames() {
    ...
    if (parent1 instanceof MemberExpression) {
      ...
      if (!(callExpression2 instanceof CallExpression) || !(property2 instanceof Identifier)) {
        return;
      }
      const memberName = property2.name;
      if (callExpression2.parent instanceof ExpressionStatement && ["catch", "finally"].includes(memberName)) {
        return EMPTY_ARRAY;
      }
      if (memberName !== "then")
        return;
      ...
      if (callExpression2.arguments.length !== 1 || !(argument instanceof ArrowFunctionExpression || argument instanceof FunctionExpression)) {
        return;
      }
...
var ExportDefaultVariable = class _ExportDefaultVariable extends LocalVariable {
  constructor(name, exportDefaultDeclaration2, context) {
    super(
      ...
      exportDefaultDeclaration2.declaration,
      context,
      "other"
      /* VariableKind.other */
    );
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-AFHWZFUE.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-TNJ2RLPL.js.map
