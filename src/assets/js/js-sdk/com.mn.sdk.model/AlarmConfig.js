...
/**
 * The AlarmConfig model module.
 * @module com.mn.sdk.model/AlarmConfig
 * @version 1.0
 */
export class AlarmConfig {
  /**
   * Constructs a new <code>AlarmConfig</code>.
   * 报警配置表实体类
   * @alias module:com.mn.sdk.model/AlarmConfig
   * @class
  ...
  constructor(alarmClassify, alarmGroup, alarmId, alarmName, confirmType, createdBy, detail, deviceId, expression, level, position, pushDelayTime, pushRestoreMessage, restoreMessage, sortNo, variantId) {
    ...
    static constructFromList(list) {
        ...
        for (const obj of list) {
            array.push(AlarmConfig.constructFromObject(obj));
        }
  ...
  /**
   * Constructs a <code>AlarmConfig</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.mn.sdk.model/AlarmConfig} obj Optional instance to populate.
   * @return {module:com.mn.sdk.model/AlarmConfig} The populated <code>AlarmConfig</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AlarmConfig();
 ...
 */
AlarmConfig.prototype.alarmClassify = undefined;

/**
 * 报警所属分组 一个32位二进制的值
 * @member {Number} alarmGroup
 */
AlarmConfig.prototype.alarmGroup = undefined;

/**
 * 报警id
 * @member {Number} alarmId
 */
AlarmConfig.prototype.alarmId = undefined;

/**
 * 报警名称
 * @member {String} alarmName
 */
AlarmConfig.prototype.alarmName = undefined;

/**
 * 报警确认类型 0:手动确认, 1:恢复后自动确认, 2:只有恢复后才能手动确认
 * @member {String} confirmType
 */
AlarmConfig.prototype.confirmType = undefined;

/**
 * 创建人
 * @member {String} createdBy
 */
AlarmConfig.prototype.createdBy = undefined;

/**
 * 报警详情
 * @member {String} detail
 */
AlarmConfig.prototype.detail = undefined;

/**
 * 虚拟设备编号
 * @member {String} deviceId
 */
AlarmConfig.prototype.deviceId = undefined;

/**
 * 报警表达式
 * @member {String} expression
 */
AlarmConfig.prototype.expression = undefined;

/**
 * 报警级别 0：一般，1：重要，2：紧急
 * @member {String} level
 */
AlarmConfig.prototype.level = undefined;

/**
 * 报警位置
 * @member {String} position
 */
AlarmConfig.prototype.position = undefined;

/**
 * 延迟推送时间(单位秒,为0时不延迟)
 * @member {String} pushDelayTime
 */
AlarmConfig.prototype.pushDelayTime = undefined;

/**
 * 是否推送报警恢复消息 0：否，1：是
 * @member {String} pushRestoreMessage
 */
AlarmConfig.prototype.pushRestoreMessage = undefined;

/**
 * 报警恢复详情
 * @member {String} restoreMessage
 */
AlarmConfig.prototype.restoreMessage = undefined;

/**
 * 排序号
 * @member {Number} sortNo
 */
AlarmConfig.prototype.sortNo = undefined;

/**
 * 变量id
 * @member {Number} variantId
 */
AlarmConfig.prototype.variantId = undefined;
